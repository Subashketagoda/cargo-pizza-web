import{j as d}from"./index-CVQzOkSx.js";import{r as N}from"./react-vendor-CXg56VsP.js";import{g as C,_ as O,a as it,b as Jt,c as nr,d as Yt,e as Ze,i as Ee,p as Xt,E as ot,q as ge,f as me,h as P,j as rr,k as sr,S as ce,l as Te,F as Ve,m as ir,n as or,L as ar,o as Qt,D as cr,r as lr,s as ur,t as dr,u as et,C as tt,v as De,w as hr,x as fr,y as pr,z as gr,A as mr,B as Et,G as qe,H as Tt,I as _r,J as Ir,K as wr}from"./firebase-vendor-CJIx-I_j.js";function Zt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const yr=Zt,en=new ot("auth","Firebase",Zt());/**
 * @license
