          ...
          <div className="footer-grid">
            ...
            <div className="footer-col footer-col--brand">
              ...
              <div className="footer__socials">
                ...
                <a href="https://www.instagram.com/cargopizzeria/" target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="Cargo Pizza on Instagram">
                ...
                <a href="https://wa.me/94778817742" target="_blank" rel="noopener noreferrer" className="footer__social" aria-label="Chat with Cargo Pizza on WhatsApp">
