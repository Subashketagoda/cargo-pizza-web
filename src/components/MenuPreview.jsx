      ...
      <div className="container menu-section__inner">
        ...
        <div className="text-center menu-section__header">
          ...
          <h2 className="section-title" style={{ color: 'var(--blue-dark)' }}>
            Discover Our <span style={{ color: 'var(--red)' }}>Menu</span>
          </h2>
          <p className="section-subtitle" style={{ color: 'rgba(26,45,109,0.7)' }}>
            Every item is handcrafted with premium ingredients and made fresh to order.
          </p>
        </div>
